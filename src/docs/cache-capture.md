...
如果默认情况下猫抓无法嗅探到资源，强烈建议优先尝试深度搜索。通过拦截一些重要函数分析出网站里隐藏的m3u8或mpd文件。还会尝试缓存m3u8文件内容，解决部分网站m3u8地址只能打开一次。并且收集所有疑似m3u8密钥的数据 [#maybekey](m3u8parse#maybekey)
...
选择 屏幕捕捉， 点击后页面出现录制区域框，调整框框大小位置，使其框选整个视频。点击开始录制后，浏览器会提示你否是允许查看标签，点击允许即可，记得勾选分享标签的音频以便录制音频。录制完成 最后格式为 webm...
...
::: info 兼容性
以上功能Chromium 102+版本以上，Firefox 128+版本以上。
:::
