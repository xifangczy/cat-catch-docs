...
许多网站会把视频和音频分离，当你勾选两条资源时(一条视频，一条音频)，`合并下载`可点击，猫抓下载器分别下载音频和视频再使用在线ffmpeg进行合并。

## 弹出

跳转到更加完善的筛选页面详情见 [筛选预览页面](preview)

## 更多功能 - 模拟手机

点击后会刷新当前页面，并修改浏览器User-Agent为手机，让网页展示出手机版页面，很多PC端无法下载和嗅探的资源在手机版页面可以被下载和嗅探。
